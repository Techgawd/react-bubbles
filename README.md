...
A token is used for signing up and verifying a user of a website and is a string of cryptic text.

- [ ] What steps can you take in your web apps to keep your data secure?

You can take many steps to keep your data secure such as protecting your routes by not having them render unless the user is authenticated with a token from a server.

- [ ] Describe how web servers work.

By using a domain name and IP address the client's browser sends an HTTP request to the web server. These servers then provide the files that make up the webpage. They then render in the user's browser.
